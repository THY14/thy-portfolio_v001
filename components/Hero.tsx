          ...
          <div className="w-full max-w-xl px-8">
            <div className="flex items-center gap-4 mb-10">
              <div className="relative w-12 h-12 flex-shrink-0">
                <div className="absolute inset-0 rounded-full border-[3px] border-orange-500 anim-spin" />
                <div className="absolute inset-[9px] rounded-full bg-orange-500" />
              </div>
              <div>
            ...
            <div className="mt-8 h-[3px] bg-white/8 rounded-full overflow-hidden">
              <div className="h-full bg-orange-500 rounded-full transition-all duration-300"
                style={{ width: `${Math.min(100, ((bootIdx + 1) / BOOT_LINES.length) * 100)}%` }} />
            </div>
          </div>
        </div>
      )}
      ...
      <div className={`max-w-7xl  mx-auto px-12 w-full py-16 grid gap-12 items-center transition-opacity duration-700  ${ready ? "opacity-100" : "opacity-0"}`}
        ...
        <div className="flex flex-col items-center gap-6 anim-fade-right d-200 lg:-mt-10 ">
          ...
          <div className="relative anim-float">
            <div className="absolute -inset-4 rounded-full border border-dashed border-orange-500/25 anim-spin" style={{ animationDuration: "14s" }} />
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={goContact}
              ...
              style={{ background: "linear-gradient(to bottom,#F47421,#C7461A)", fontFamily: "'Ubuntu',sans-serif", boxShadow: "0 2px 8px rgba(233,84,32,0.4)" }}>
