      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {skillCategories.map((cat, ci) => (
            <div key={cat.title}
              className={`rounded-xl border border-white/8 overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:shadow-xl ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
              ...
              <div className="flex items-center gap-1.5 px-3 py-2 border-b border-black/30" style={{ background: "#2e2841" }}>
                ...
                <span className="ml-1.5 text-[14px] font-bold truncate" style={{ fontFamily: "'Ubuntu Mono',monospace", color: "var(--accent)" }}>
